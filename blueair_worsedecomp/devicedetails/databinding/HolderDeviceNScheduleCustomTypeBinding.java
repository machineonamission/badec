...
public final class HolderDeviceNScheduleCustomTypeBinding implements ViewBinding {
    ...
    private HolderDeviceNScheduleCustomTypeBinding(ConstraintLayout constraintLayout, RadioButton radioButton, RadioButton radioButton2, RadioGroup radioGroup, TextView textView, TextView textView2) {
    ...
    public static HolderDeviceNScheduleCustomTypeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.holder_device_n_schedule_custom_type, viewGroup, false);
        if (z) {
            ...
            if (radioButton2 != null) {
                ...
                if (radioGroup != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            return new HolderDeviceNScheduleCustomTypeBinding((ConstraintLayout) view, radioButton, radioButton2, radioGroup, textView, textView2);
                        }
                    }
                }
            }
