...
public final class DeviceDetailsViewModel$special$$inlined$observable$4 extends ObservableProperty<DeviceData> {
    final /* synthetic */ DeviceDetailsViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DeviceDetailsViewModel$special$$inlined$observable$4(Object obj, DeviceDetailsViewModel deviceDetailsViewModel) {
        super(obj);
        this.this$0 = deviceDetailsViewModel;
    }

    /* access modifiers changed from: protected */
    public void afterChange(KProperty<?> kProperty, DeviceData deviceData, DeviceData deviceData2) {
        Intrinsics.checkNotNullParameter(kProperty, "property");
        if (!Intrinsics.areEqual((Object) deviceData, (Object) deviceData2)) {
