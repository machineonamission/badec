...
public final class DeviceRefresherEnabledHolder extends DeviceSettingHolder {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceRefresherEnabledHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceRefresherEnabledHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* compiled from: DeviceRefresherEnabledHolder.kt */
    public static final class Companion {
        ...
        public final DeviceRefresherEnabledHolder newInstance(ViewGroup viewGroup) {
            ...
            return new DeviceRefresherEnabledHolder(inflate);
        }
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public DeviceRefresherEnabledHolder(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding r3) {
        /*
            r2 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blueair.devicedetails.viewholder.DeviceRefresherEnabledHolder.<init>(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding):void");
    }
    ...
    public void update(Device device) {
        ...
        super.update(device);
        int i2 = R.string.label_water_refresher;
        if (device instanceof DeviceCombo2in120) {
            i = R.string.water_refresher_description_2in120;
        } else {
            i = R.string.water_refresher_description;
        }
        boolean z = false;
        getSettingTitle().setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.ic_water_refresher, 0, 0, 0);
        ...
        if (hasRemoveYellowWater != null) {
            z = Intrinsics.areEqual((Object) hasRemoveYellowWater.getYwrmEnabled(), (Object) true);
        }
