...
public final class DeviceDisplayModeHolder extends DeviceSettingHolder {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceDisplayModeHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceDisplayModeHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* compiled from: DeviceDisplayModeHolder.kt */
    public static final class Companion {
        ...
        public final DeviceDisplayModeHolder newInstance(ViewGroup viewGroup) {
            ...
            return new DeviceDisplayModeHolder(inflate);
        }
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public DeviceDisplayModeHolder(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding r3) {
        /*
            r2 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blueair.devicedetails.viewholder.DeviceDisplayModeHolder.<init>(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding):void");
    }
    ...
    public void update(Device device) {
        ...
        super.update(device);
        int i = R.string.display_mode;
        int i2 = R.string.display_mode_desc;
        boolean z = false;
        getSettingTitle().setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.ic_display_mode_leading, 0, 0, 0);
        ...
        HasDisplayMode hasDisplayMode = device instanceof HasDisplayMode ? (HasDisplayMode) device : null;
        if (hasDisplayMode != null && hasDisplayMode.getPanelDisplayMode() == PanelDisplayMode.ON.getValue()) {
            z = true;
        }
