...
public final class DeviceTVOCSettingHolder extends DeviceSettingHolder {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceTVOCSettingHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceTVOCSettingHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* compiled from: DeviceTVOCSettingHolder.kt */
    public static final class Companion {
        ...
        public final DeviceTVOCSettingHolder newInstance(ViewGroup viewGroup) {
            ...
            return new DeviceTVOCSettingHolder(inflate);
        }
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public DeviceTVOCSettingHolder(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding r3) {
        /*
            r2 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blueair.devicedetails.viewholder.DeviceTVOCSettingHolder.<init>(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding):void");
    }
    ...
    public void update(Device device) {
        ...
        super.update(device);
        int i = R.string.pet_sensor_tvoc;
        int i2 = R.string.setting_tvoc_desc;
        boolean z = false;
        getSettingTitle().setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.ic_tvoc, 0, 0, 0);
        TextViewCompat.setCompoundDrawableTintList(getSettingTitle(), ColorStateList.valueOf(this.itemView.getContext().getColor(R.color.colorPrimary)));
        ...
        DeviceBlue40 deviceBlue40 = device instanceof DeviceBlue40 ? (DeviceBlue40) device : null;
        if (deviceBlue40 != null && deviceBlue40.useTVOCForAqi()) {
            z = true;
        }
