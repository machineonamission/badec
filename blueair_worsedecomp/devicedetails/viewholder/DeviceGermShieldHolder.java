...
public final class DeviceGermShieldHolder extends DeviceSettingHolder {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceGermShieldHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceGermShieldHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* compiled from: DeviceGermShieldHolder.kt */
    public static final class Companion {
        ...
        public final DeviceGermShieldHolder newInstance(ViewGroup viewGroup) {
            ...
            return new DeviceGermShieldHolder(inflate);
        }
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public DeviceGermShieldHolder(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding r3) {
        /*
            r2 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blueair.devicedetails.viewholder.DeviceGermShieldHolder.<init>(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding):void");
    }
    ...
    public void update(Device device) {
        ...
        super.update(device);
        if (((HasGermShieldMode) device).isGermShieldPlus()) {
            i = R.string.germ_shield_plus;
            i2 = R.string.germ_shield_plus_mode_summary;
        } else {
            i = R.string.germ_shield_setting;
            i2 = R.string.germ_shield_mode_summary;
        }
        getSettingTitle().setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.ic_germshield_leading, 0, 0, 0);
    ...
    public void setOnline(Device device) {
        ...
        if (device instanceof HasGermShieldMode) {
            getSettingSwitch().setCheckedSilence(((HasGermShieldMode) device).isGermShieldModeOn());
        }
