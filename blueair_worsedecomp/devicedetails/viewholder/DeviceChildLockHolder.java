...
public final class DeviceChildLockHolder extends DeviceSettingHolder {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceChildLockHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceChildLockHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* compiled from: DeviceChildLockHolder.kt */
    public static final class Companion {
        ...
        public final DeviceChildLockHolder newInstance(ViewGroup viewGroup) {
            ...
            return new DeviceChildLockHolder(inflate);
        }
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public DeviceChildLockHolder(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding r3) {
        /*
            r2 = this;
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blueair.devicedetails.viewholder.DeviceChildLockHolder.<init>(com.blueair.devicedetails.databinding.HolderDeviceSettingModeBinding):void");
    }
    ...
    public void update(Device device) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.itemView.getContext().getText(R.string.child_lock_setting));
        spannableStringBuilder.append(" ￼");
        spannableStringBuilder.setSpan(new ImageSpan(this.itemView.getContext(), R.drawable.ic_childlock, 1), spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 17);
        settingTitle2.setText(spannableStringBuilder);
        getSettingSwitch().setContentDescription(this.itemView.getContext().getText(R.string.child_lock_setting));
        getSettingSummary().setText(this.itemView.getContext().getText(R.string.child_lock_mode_summary));
    }

    public void setOnline(Device device) {
        Intrinsics.checkNotNullParameter(device, "device");
        super.setOnline(device);
        if (device instanceof HasChildLock) {
            getSettingSwitch().setCheckedSilence(((HasChildLock) device).isChildLockOn());
        }
