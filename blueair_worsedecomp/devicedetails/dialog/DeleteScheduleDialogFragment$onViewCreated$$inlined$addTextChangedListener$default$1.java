...
public final class DeleteScheduleDialogFragment$onViewCreated$$inlined$addTextChangedListener$default$1 implements TextWatcher {
    ...
    public DeleteScheduleDialogFragment$onViewCreated$$inlined$addTextChangedListener$default$1(DeleteScheduleDialogFragment deleteScheduleDialogFragment) {
        this.this$0 = deleteScheduleDialogFragment;
    }

    public void afterTextChanged(Editable editable) {
        CharSequence charSequence;
        List<DeviceScheduleMerged> value = this.this$0.getViewModel().getSchedules().getValue();
        if (value != null) {
            if (editable == null || (charSequence = StringsKt.trim((CharSequence) editable)) == null) {
            }
            if (charSequence.length() == 0) {
                ItemAdapter access$getScheduleAdapter$p = this.this$0.scheduleAdapter;
                if (access$getScheduleAdapter$p == null) {
                    Intrinsics.throwUninitializedPropertyAccessException("scheduleAdapter");
                    access$getScheduleAdapter$p = null;
                }
                IItemAdapter iItemAdapter = access$getScheduleAdapter$p;
            ...
            for (DeviceScheduleMerged deviceScheduleMerged2 : value) {
                CharSequence name2 = deviceScheduleMerged2.getName();
                ...
                if (StringsKt.contains((CharSequence) str, charSequence, true)) {
                    arrayList2.add(new DeletableItem(str, deviceScheduleMerged2, false, 4, (DefaultConstructorMarker) null));
                }
            }
            ItemAdapter access$getScheduleAdapter$p2 = this.this$0.scheduleAdapter;
            if (access$getScheduleAdapter$p2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("scheduleAdapter");
                access$getScheduleAdapter$p2 = null;
            }
            ModelAdapter modelAdapter2 = (ModelAdapter) IItemAdapter.DefaultImpls.setNewList$default(access$getScheduleAdapter$p2, arrayList2, false, 2, (Object) null);
        }
    }
}
