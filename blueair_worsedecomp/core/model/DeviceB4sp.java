...
public final class DeviceB4sp implements Device, HasFanSpeed, HasInfo, HasBlueProvisionCalls, HasSensorData, HasBlueCloudFunctions, HasChildLock, HasBrightness, HasStandBy, HasG4NightMode, HasScheduling, HasSKU, HasWelcomeHome {
    ...
    /* compiled from: Device.kt */
    public static final class Creator implements Parcelable.Creator<DeviceB4sp> {
        public final DeviceB4sp createFromParcel(Parcel parcel) {
            boolean z;
            boolean z2;
            boolean z3;
            ...
            return new DeviceB4sp(readString, readString2, readInt, valueOf, readInt2, readString3, readString4, createFromParcel, z5, indoorDatapoint, readInt3, z3, readInt4, readLong, readString5, readString6, readString7, readString8, readString9, readString10, readString11, readString12, readString13, readString14, readString15, createDoubleArray, createDoubleArray2, createDoubleArray3, createDoubleArray4, createDoubleArray5, readInt5, z16, z17, readString16, readString17, readInt6, readString18, welcomeHomeLocation);
        }

        public final DeviceB4sp[] newArray(int i) {
            return new DeviceB4sp[i];
        }
    }

    public static /* synthetic */ DeviceB4sp copy$default(DeviceB4sp deviceB4sp, String str, String str2, int i, Integer num, int i2, String str3, String str4, DeviceUuid deviceUuid2, boolean z, IndoorDatapoint indoorDatapoint, int i3, boolean z2, int i4, long j, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, double[] dArr, double[] dArr2, double[] dArr3, double[] dArr4, double[] dArr5, int i5, boolean z3, boolean z4, String str16, String str17, int i6, String str18, WelcomeHomeLocation welcomeHomeLocation, int i7, int i8, Object obj) {
        ...
        Integer num2;
        int i14;
        DeviceB4sp deviceB4sp2 = deviceB4sp;
        int i15 = i7;
        String str35 = (i15 & 1) != 0 ? deviceB4sp2.uid : str;
        String str36 = (i15 & 2) != 0 ? deviceB4sp2.name : str2;
        int i16 = (i15 & 4) != 0 ? deviceB4sp2.fanSpeed : i;
        Integer num3 = (i15 & 8) != 0 ? deviceB4sp2.filterLife : num;
        int i17 = (i15 & 16) != 0 ? deviceB4sp2.brightness : i2;
        String str37 = (i15 & 32) != 0 ? deviceB4sp2.autoModeText : str3;
        String str38 = (i15 & 64) != 0 ? deviceB4sp2.info : str4;
        DeviceUuid deviceUuid4 = (i15 & 128) != 0 ? deviceB4sp2.deviceUuid : deviceUuid2;
        boolean z9 = (i15 & 256) != 0 ? deviceB4sp2.hasFinishedOnboarding : z;
        IndoorDatapoint indoorDatapoint3 = (i15 & 512) != 0 ? deviceB4sp2.latestSensorDatapoint : indoorDatapoint;
        int i18 = (i15 & 1024) != 0 ? deviceB4sp2.lastSelectedSensorTypeIndex : i3;
        boolean z10 = (i15 & 2048) != 0 ? deviceB4sp2.isChildLockOn : z2;
        int i19 = (i15 & 4096) != 0 ? deviceB4sp2.connectivityStatusIndex : i4;
        String str39 = str35;
        String str40 = str36;
        long j3 = (i15 & 8192) != 0 ? deviceB4sp2.lastConnectivityInMillis : j;
        String str41 = (i15 & 16384) != 0 ? deviceB4sp2.mac : str5;
        String str42 = (i15 & 32768) != 0 ? deviceB4sp2.mcuFirmware : str6;
        String str43 = (i7 & 65536) != 0 ? deviceB4sp2.wifiFirmware : str7;
        String str44 = (i7 & 131072) != 0 ? deviceB4sp2.hardware : str8;
        String str45 = (i7 & 262144) != 0 ? deviceB4sp2.timeZone : str9;
        String str46 = (i7 & 524288) != 0 ? deviceB4sp2.serial : str10;
        String str47 = (i7 & 1048576) != 0 ? deviceB4sp2.purchaseDate : str11;
        String str48 = (i7 & 2097152) != 0 ? deviceB4sp2.dealerName : str12;
        String str49 = (i7 & 4194304) != 0 ? deviceB4sp2.dealerCountry : str13;
        String str50 = (i7 & 8388608) != 0 ? deviceB4sp2.filterType : str14;
        String str51 = (i7 & 16777216) != 0 ? deviceB4sp2.filterTrigger : str15;
        double[] dArr11 = (i7 & 33554432) != 0 ? deviceB4sp2.pm1Ranges : dArr;
        double[] dArr12 = (i7 & AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL) != 0 ? deviceB4sp2.pm10Ranges : dArr2;
        double[] dArr13 = (i7 & 134217728) != 0 ? deviceB4sp2.pm25Ranges : dArr3;
        double[] dArr14 = (i7 & 268435456) != 0 ? deviceB4sp2.vocRanges : dArr4;
        double[] dArr15 = (i7 & 536870912) != 0 ? deviceB4sp2.hchoRanges : dArr5;
        int i20 = (i7 & 1073741824) != 0 ? deviceB4sp2.updateProgress : i5;
        boolean z11 = (i7 & Integer.MIN_VALUE) != 0 ? deviceB4sp2.isStandByOn : z3;
        boolean z12 = (i8 & 1) != 0 ? deviceB4sp2.isG4NightModeOn : z4;
        String str52 = (i8 & 2) != 0 ? deviceB4sp2.g4NightModeFilterTrigger : str16;
        String str53 = (i8 & 4) != 0 ? deviceB4sp2.modelName : str17;
        int i21 = (i8 & 8) != 0 ? deviceB4sp2.typeIndex : i6;
        String str54 = (i8 & 16) != 0 ? deviceB4sp2.sku : str18;
        if ((i8 & 32) != 0) {
            str19 = str54;
            welcomeHomeLocation2 = deviceB4sp2.welcomeHome;
            str24 = str49;
            str23 = str50;
            str22 = str51;
            dArr10 = dArr11;
        ...
        return deviceB4sp2.copy(str39, str40, i14, num2, i13, str34, str33, deviceUuid3, z8, indoorDatapoint2, i12, z7, i11, j2, str32, str31, str30, str29, str28, str27, str26, str25, str24, str23, str22, dArr10, dArr9, dArr8, dArr7, dArr6, i10, z6, z5, str21, str20, i9, str19, welcomeHomeLocation2);
    }
    ...
    public final DeviceB4sp copy(String str, String str2, int i, Integer num, int i2, String str3, String str4, DeviceUuid deviceUuid2, boolean z, IndoorDatapoint indoorDatapoint, int i3, boolean z2, int i4, long j, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, double[] dArr, double[] dArr2, double[] dArr3, double[] dArr4, double[] dArr5, int i5, boolean z3, boolean z4, String str16, String str17, int i6, String str18, WelcomeHomeLocation welcomeHomeLocation) {
        String str19 = str;
        ...
        String str41 = str31;
        double[] dArr7 = dArr6;
        return new DeviceB4sp(str19, str20, i, num, i2, str21, str4, deviceUuid2, z, indoorDatapoint, i3, z2, i4, j, str5, str32, str33, str34, str35, str36, str37, str38, str39, str40, str41, dArr7, dArr2, dArr3, dArr4, dArr5, i5, z3, z4, str16, str17, i6, str18, welcomeHomeLocation);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DeviceB4sp)) {
            return false;
        }
        DeviceB4sp deviceB4sp = (DeviceB4sp) obj;
        return Intrinsics.areEqual((Object) this.uid, (Object) deviceB4sp.uid) && Intrinsics.areEqual((Object) this.name, (Object) deviceB4sp.name) && this.fanSpeed == deviceB4sp.fanSpeed && Intrinsics.areEqual((Object) this.filterLife, (Object) deviceB4sp.filterLife) && this.brightness == deviceB4sp.brightness && Intrinsics.areEqual((Object) this.autoModeText, (Object) deviceB4sp.autoModeText) && Intrinsics.areEqual((Object) this.info, (Object) deviceB4sp.info) && Intrinsics.areEqual((Object) this.deviceUuid, (Object) deviceB4sp.deviceUuid) && this.hasFinishedOnboarding == deviceB4sp.hasFinishedOnboarding && Intrinsics.areEqual((Object) this.latestSensorDatapoint, (Object) deviceB4sp.latestSensorDatapoint) && this.lastSelectedSensorTypeIndex == deviceB4sp.lastSelectedSensorTypeIndex && this.isChildLockOn == deviceB4sp.isChildLockOn && this.connectivityStatusIndex == deviceB4sp.connectivityStatusIndex && this.lastConnectivityInMillis == deviceB4sp.lastConnectivityInMillis && Intrinsics.areEqual((Object) this.mac, (Object) deviceB4sp.mac) && Intrinsics.areEqual((Object) this.mcuFirmware, (Object) deviceB4sp.mcuFirmware) && Intrinsics.areEqual((Object) this.wifiFirmware, (Object) deviceB4sp.wifiFirmware) && Intrinsics.areEqual((Object) this.hardware, (Object) deviceB4sp.hardware) && Intrinsics.areEqual((Object) this.timeZone, (Object) deviceB4sp.timeZone) && Intrinsics.areEqual((Object) this.serial, (Object) deviceB4sp.serial) && Intrinsics.areEqual((Object) this.purchaseDate, (Object) deviceB4sp.purchaseDate) && Intrinsics.areEqual((Object) this.dealerName, (Object) deviceB4sp.dealerName) && Intrinsics.areEqual((Object) this.dealerCountry, (Object) deviceB4sp.dealerCountry) && Intrinsics.areEqual((Object) this.filterType, (Object) deviceB4sp.filterType) && Intrinsics.areEqual((Object) this.filterTrigger, (Object) deviceB4sp.filterTrigger) && Intrinsics.areEqual((Object) this.pm1Ranges, (Object) deviceB4sp.pm1Ranges) && Intrinsics.areEqual((Object) this.pm10Ranges, (Object) deviceB4sp.pm10Ranges) && Intrinsics.areEqual((Object) this.pm25Ranges, (Object) deviceB4sp.pm25Ranges) && Intrinsics.areEqual((Object) this.vocRanges, (Object) deviceB4sp.vocRanges) && Intrinsics.areEqual((Object) this.hchoRanges, (Object) deviceB4sp.hchoRanges) && this.updateProgress == deviceB4sp.updateProgress && this.isStandByOn == deviceB4sp.isStandByOn && this.isG4NightModeOn == deviceB4sp.isG4NightModeOn && Intrinsics.areEqual((Object) this.g4NightModeFilterTrigger, (Object) deviceB4sp.g4NightModeFilterTrigger) && Intrinsics.areEqual((Object) this.modelName, (Object) deviceB4sp.modelName) && this.typeIndex == deviceB4sp.typeIndex && Intrinsics.areEqual((Object) this.sku, (Object) deviceB4sp.sku) && Intrinsics.areEqual((Object) this.welcomeHome, (Object) deviceB4sp.welcomeHome);
    }
    ...
    public DeviceB4sp(String str, String str2, int i, Integer num, int i2, String str3, String str4, DeviceUuid deviceUuid2, boolean z, IndoorDatapoint indoorDatapoint, int i3, boolean z2, int i4, long j, String str5, String str6, String str7, String str8, String str9, String str10, String str11, String str12, String str13, String str14, String str15, double[] dArr, double[] dArr2, double[] dArr3, double[] dArr4, double[] dArr5, int i5, boolean z3, boolean z4, String str16, String str17, int i6, String str18, WelcomeHomeLocation welcomeHomeLocation) {
        String str19 = str;
        String str20 = str2;
        String str21 = str3;
        String str22 = str5;
    ...
    public /* synthetic */ DeviceB4sp(java.lang.String r43, java.lang.String r44, int r45, java.lang.Integer r46, int r47, java.lang.String r48, java.lang.String r49, com.blueair.core.model.DeviceUuid r50, boolean r51, com.blueair.core.model.IndoorDatapoint r52, int r53, boolean r54, int r55, long r56, java.lang.String r58, java.lang.String r59, java.lang.String r60, java.lang.String r61, java.lang.String r62, java.lang.String r63, java.lang.String r64, java.lang.String r65, java.lang.String r66, java.lang.String r67, java.lang.String r68, double[] r69, double[] r70, double[] r71, double[] r72, double[] r73, int r74, boolean r75, boolean r76, java.lang.String r77, java.lang.String r78, int r79, java.lang.String r80, com.blueair.core.model.WelcomeHomeLocation r81, int r82, int r83, kotlin.jvm.internal.DefaultConstructorMarker r84) {
        ...
        L_0x014e:
            ...
            com.blueair.core.model.DeviceType$B4sp r0 = com.blueair.core.model.DeviceType.B4sp.INSTANCE
            int r0 = r0.getIndex()
            r39 = r0
            goto L_0x015d
        L_0x015b:
        ...
        L_0x0166:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.blueair.core.model.DeviceB4sp.<init>(java.lang.String, java.lang.String, int, java.lang.Integer, int, java.lang.String, java.lang.String, com.blueair.core.model.DeviceUuid, boolean, com.blueair.core.model.IndoorDatapoint, int, boolean, int, long, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, double[], double[], double[], double[], double[], int, boolean, boolean, java.lang.String, java.lang.String, int, java.lang.String, com.blueair.core.model.WelcomeHomeLocation, int, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
