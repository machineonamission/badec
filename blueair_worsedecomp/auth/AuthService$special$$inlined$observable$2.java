...
public final class AuthService$special$$inlined$observable$2 extends ObservableProperty<String> {
    final /* synthetic */ AuthService this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AuthService$special$$inlined$observable$2(Object obj, AuthService authService) {
        super(obj);
    ...
    public void afterChange(KProperty<?> kProperty, String str, String str2) {
        ...
        if (str3.length() == 0) {
            this.this$0.securePrefs.remove(PrefKeys.EncryptedEmail);
        } else {
            PreferencesHelper.INSTANCE.set(this.this$0.securePrefs.getBackend(), PrefKeys.EncryptedEmail, str3, Reflection.getOrCreateKotlinClass(String.class));
        }
    }
}
