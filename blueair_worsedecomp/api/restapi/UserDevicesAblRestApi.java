...
public interface UserDevicesAblRestApi {
    ...
    Object addDevice(@Path("username") String str, @Path("uuid") String str2, Continuation<? super Response<Object>> continuation);

    @GET("/v2/device/{uuid}/info/")
    Object getDeviceDetails(@Path("uuid") String str, Continuation<? super Response<DeviceDetailsOnAblServer>> continuation);

    @GET("/v2/owner/{username}/device/")
    Object getDeviceList(@Path("username") String str, Continuation<? super Response<List<DeviceSparseOnAblServer>>> continuation);

    @GET("/v2/user/{username}/attribute/temperature/")
    Object getTemperaturePreference(@Path("username") String str, Continuation<? super Response<TemperatureAttributeDto>> continuation);

    @POST("/v2/owner/{username}/release/{uuid}/")
    Object removeDevice(@Path("username") String str, @Path("uuid") String str2, Continuation<? super Response<Object>> continuation);

    @POST("/v2/device/{uuid}/repair_id/")
    Object repairDevice(@Path("uuid") String str, @Body RepairBody repairBody, Continuation<? super Response<RepairBody>> continuation);

    @POST("/v2/device/{uuid}/attributes/reset/")
    Object resetAttributes(@Path("uuid") String str, Continuation<? super Response<Object>> continuation);

    @POST("/v2/user/{username}/attribute/temperature/")
    Object setTemperaturePreference(@Path("username") String str, @Body TemperatureAttributeDto temperatureAttributeDto, Continuation<? super Response<Unit>> continuation);

    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\t\b\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0005XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0005XT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0005XT¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0005XT¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0005XT¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0005XT¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u0005XT¢\u0006\u0002\n\u0000¨\u0006\u000e"}, d2 = {"Lcom/blueair/api/restapi/UserDevicesAblRestApi$Companion;", "", "<init>", "()V", "USERNAME", "", "UUID", "GET_DEVICE_LIST", "GET_DEVICE_DETAILS", "REMOVE_DEVICE", "REPAIR_DEVICE", "ADD_DEVICE", "RESET_ATTRIBUTES", "TEMPERATURE", "api_otherRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
    /* compiled from: UserDevicesAblRestApi.kt */
