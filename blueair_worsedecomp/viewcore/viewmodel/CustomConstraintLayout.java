...
import com.blueair.viewcore.viewmodel.MvvmCustomView;
...
public abstract class CustomConstraintLayout<S extends Parcelable, VM extends MvvmCustomViewModel<S>> extends ConstraintLayout implements MvvmCustomView<S, VM> {
    public abstract void onStateUpdate(S s);

    public void attachLifeCycle(Context context) {
        MvvmCustomView.CC.$default$attachLifeCycle(this, context);
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        if (parcelable instanceof MvvmCustomViewStateWrapper) {
            MvvmCustomViewModel viewModel = getViewModel();
    ...
    public void onLifecycleOwnerAttached(LifecycleOwner lifecycleOwner) {
        ...
        LiveDataExtensionsKt.observeNonNull(getViewModel().getLiveData(), lifecycleOwner, new CustomConstraintLayout$$ExternalSyntheticLambda0(this));
    }

    /* access modifiers changed from: private */
    public static final Unit onLifecycleOwnerAttached$lambda$0(CustomConstraintLayout customConstraintLayout, Parcelable parcelable) {
        Intrinsics.checkNotNull(parcelable);
        customConstraintLayout.onStateUpdate(parcelable);
