...
public class DataBinderMapperImpl extends DataBinderMapper {
    ...
    public List<DataBinderMapper> collectDependencies() {
        ...
        arrayList.add(new com.blueair.ble.DataBinderMapperImpl());
        arrayList.add(new com.blueair.bluetooth.DataBinderMapperImpl());
        arrayList.add(new com.blueair.core.DataBinderMapperImpl());
        arrayList.add(new com.blueair.database.DataBinderMapperImpl());
        arrayList.add(new com.blueair.livestream.DataBinderMapperImpl());
        return arrayList;
    }
