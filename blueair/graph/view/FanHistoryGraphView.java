...
public final class FanHistoryGraphView extends GraphView {
   ...
   // $FF: synthetic method
   public static int[] $r8$lambda$t3UGpQsSRbcQoLkGQHgCXKP_okA/* $FF was: $r8$lambda$t3UGpQsSRbcQoLkGQHgCXKP-okA*/(FanHistoryGraphView var0) {
      return graphLineGradient_delegate$lambda$0(var0);
   }

   public FanHistoryGraphView(Context var1) {
      ...
      this.graphLineGradient$delegate = LazyKt.lazy(new FanHistoryGraphView$$ExternalSyntheticLambda0(this));
      this.graphfillDrawable = R.drawable.fill_gradient_fan_graph;
      this.getViewModel().setSensorType(SensorType.FAN);
   }

   public FanHistoryGraphView(Context var1, AttributeSet var2) {
      Intrinsics.checkNotNullParameter(var1, "context");
   ...
   public FanHistoryGraphView(Context var1, AttributeSet var2, int var3) {
      Intrinsics.checkNotNullParameter(var1, "context");
   ...
   private static final int[] graphLineGradient_delegate$lambda$0(FanHistoryGraphView var0) {
      return new int[]{ResourcesCompat.getColor(var0.getResources(), R.color.marineblue, var0.getContext().getTheme()), ResourcesCompat.getColor(var0.getResources(), R.color.aquablue, var0.getContext().getTheme()), ResourcesCompat.getColor(var0.getResources(), R.color.lightbluegrey, var0.getContext().getTheme())};
   }
   ...
   public void setupUiOverlay() {
      this.getBinding().graphHeader.setVisibility(8);
      this.getBinding().buttonInfo.setVisibility(8);
   }
   ...
   public void updateHeaderSelectedDatapoint(GraphView.SelectedPoint var1) {
      ...
      int var2 = R.color.marineblue;
      GraphView.updateHeaderSelectedDatapoint$default(this, var1, (String)null, var2, (String)null, (String)null, 16, (Object)null);
   }

   public final Object updateHistorical(List var1, Continuation var2) {
      GraphViewModel.updateIndoorHistorical$default(this.getViewModel(), var1, false, GraphState.Companion.indoorDefault().getDeviceRatings(), false, (SensorType)null, 24, (Object)null);
      return Unit.INSTANCE;
   }

   public final Object updateRealTime(List var1, Continuation var2) {
      GraphViewModel.updateIndoorRealTime$default(this.getViewModel(), var1, false, GraphState.Companion.indoorDefault().getDeviceRatings(), (SensorType)null, 8, (Object)null);
      return Unit.INSTANCE;
   }
}
