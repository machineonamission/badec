...
public interface AqiDataDao {
   ...
   Object delete(List var1, Continuation var2);

   Object deleteAll(Continuation var1);

   Object getAqiData(String var1, Continuation var2);

   List getAqiData();

   LiveData getLiveAqiData();

   LiveData getLiveAqiData(String var1);

   Object insert(AqiDataEntity var1, Continuation var2);

   Object insertAll(List var1, Continuation var2);
}
