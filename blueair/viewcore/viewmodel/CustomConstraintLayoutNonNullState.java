...
public abstract class CustomConstraintLayoutNonNullState extends ConstraintLayout implements MvvmCustomViewNonNullState {
   // $FF: synthetic method
   public static Unit $r8$lambda$fTLDtjve6z0dY_ICsN75TZaaUA8/* $FF was: $r8$lambda$fTLDtjve6z0dY-ICsN75TZaaUA8*/(CustomConstraintLayoutNonNullState var0, Parcelable var1) {
      return onLifecycleOwnerAttached$lambda$0(var0, var1);
   }

   public CustomConstraintLayoutNonNullState(Context var1) {
      Intrinsics.checkNotNullParameter(var1, "context");
      super(var1);
   }

   public CustomConstraintLayoutNonNullState(Context var1, AttributeSet var2) {
      Intrinsics.checkNotNullParameter(var1, "context");
      Intrinsics.checkNotNullParameter(var2, "attrSet");
      super(var1, var2);
   }

   public CustomConstraintLayoutNonNullState(Context var1, AttributeSet var2, int var3) {
      Intrinsics.checkNotNullParameter(var1, "context");
      super(var1, var2, var3);
   }

   private static final Unit onLifecycleOwnerAttached$lambda$0(CustomConstraintLayoutNonNullState var0, Parcelable var1) {
   ...
   public void attachLifeCycle(LifecycleOwner var1) {
      MvvmCustomViewNonNullState$_CC.$default$attachLifeCycle(this, var1);
   }
   ...
   public void onLifecycleOwnerAttached(LifecycleOwner var1) {
      ...
      LiveDataExtensionsKt.observeNonNull((LiveData)this.getViewModel().getLiveData(), var1, new CustomConstraintLayoutNonNullState$$ExternalSyntheticLambda0(this));
   }

   protected void onRestoreInstanceState(Parcelable var1) {
      if (var1 instanceof MvvmCustomViewStateWrapper) {
         MvvmCustomViewModelNonNullState var2 = this.getViewModel();
         var1 = var1;
         Parcelable var3 = var1.getState();
         Intrinsics.checkNotNull(var3, "null cannot be cast to non-null type S of com.blueair.viewcore.viewmodel.CustomConstraintLayoutNonNullState");
         var2.setState(var3);
         super.onRestoreInstanceState(var1.getSuperState());
      }

   }

   protected MvvmCustomViewStateWrapper onSaveInstanceState() {
      return new MvvmCustomViewStateWrapper(super.onSaveInstanceState(), this.getViewModel().onSaveState());
   }
