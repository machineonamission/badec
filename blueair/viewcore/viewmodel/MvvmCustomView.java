...
public interface MvvmCustomView {
   void attachLifeCycle(Context var1);

   MvvmCustomViewModel getViewModel();
   ...
   public static final class DefaultImpls {
      @Deprecated
      public static void attachLifeCycle(MvvmCustomView var0, Context var1) {
         Intrinsics.checkNotNullParameter(var1, "context");
         MvvmCustomView$_CC.access$attachLifeCycle$jd(var0, var1);
      }
   }
}
