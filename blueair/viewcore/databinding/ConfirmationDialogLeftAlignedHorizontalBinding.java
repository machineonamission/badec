...
public final class ConfirmationDialogLeftAlignedHorizontalBinding implements ViewBinding {
   ...
   private ConfirmationDialogLeftAlignedHorizontalBinding(LinearLayout var1, TextView var2, Guideline var3, MaterialButton var4, MaterialButton var5, Guideline var6, AppCompatImageView var7, Guideline var8, TextView var9, TextView var10, Guideline var11) {
      this.rootView = var1;
      this.body = var2;
   ...
   public static ConfirmationDialogLeftAlignedHorizontalBinding bind(View var0) {
      int var1 = R.id.body;
                        ...
                        if (var8 != null) {
                           ...
                           if (var6 != null) {
                              ...
                              if (var3 != null) {
                                 ...
                                 if (var7 != null) {
                                    return new ConfirmationDialogLeftAlignedHorizontalBinding((LinearLayout)var0, var10, var4, var2, var5, var11, var9, var8, var6, var3, var7);
                                 }
                              }
                           }
                        }
   ...
   public static ConfirmationDialogLeftAlignedHorizontalBinding inflate(LayoutInflater var0) {
      return inflate(var0, (ViewGroup)null, false);
   }

   public static ConfirmationDialogLeftAlignedHorizontalBinding inflate(LayoutInflater var0, ViewGroup var1, boolean var2) {
      View var3 = var0.inflate(R.layout.confirmation_dialog_left_aligned_horizontal, var1, false);
      if (var2) {
         var1.addView(var3);
      }
