...
public class HolderDeviceFilterBindingImpl extends HolderDeviceFilterBinding {
   ...
   static {
      ...
      var0.put(R.id.name, 2);
      var0.put(R.id.btn_select, 3);
   }

   public HolderDeviceFilterBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 4, sIncludes, sViewsWithIds));
   }

   private HolderDeviceFilterBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (MaterialButton)var3[3], (AppCompatImageView)var3[1], (TextView)var3[2]);
      this.mDirtyFlags = -1L;
