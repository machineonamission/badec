...
public abstract class BaseFragment extends Fragment implements BaseFragmentInterface, DIAware, CoroutineScope {
   ...
   // $FF: synthetic method
   public static Unit $r8$lambda$oQ8hy13fpz5Gr6wlsycbZM5VTdE(BaseFragment var0, BaseViewModelEvent var1) {
      return onResume$lambda$5(var0, var1);
   }

   // $FF: synthetic method
   public static CompositeDisposable $r8$lambda$ukf_vEHQEgguLDMWTFf_Qmaed7I/* $FF was: $r8$lambda$ukf_vEHQEgguLDMWTFf-Qmaed7I*/() {
   ...
   public BaseFragment() {
      ...
      this.analytics$delegate = DIAwareKt.Instance(var4, (TypeToken)(new GenericJVMTypeTokenDelegate(var3, AnalyticsService.class)), (Object)null).provideDelegate(this, var1[1]);
      this.rxSubs$delegate = LazyKt.lazy(new BaseFragment$$ExternalSyntheticLambda0());
   }

   private static final Unit onResume$lambda$5(BaseFragment var0, BaseViewModelEvent var1) {
      ...
      if (Intrinsics.areEqual(var2, BaseViewModelAction.PressBack.INSTANCE)) {
         ...
         FragmentActivity var5 = var0.getActivity();
         if (var5 != null) {
            ...
            ViewUtils.INSTANCE.showSnackbar((Activity)var5, var11.getMessageResId(), var11.getType());
         }
         ...
         if (var6 != null) {
            ...
            Fragment var15 = var7.findFragmentByTag(PopupDialogFragment.Companion.getTAG());
            if (var15 != null) {
               var7.beginTransaction().remove(var15).commit();
            }

            PopupDialogFragment.Companion var16 = PopupDialogFragment.Companion;
            ...
            var16.newInstance((PopupMessage)var12).show(var7, PopupDialogFragment.Companion.getTAG());
         }
      } else {
   ...
   public CoroutineContext getCoroutineContext() {
      ...
      return LifecycleOwnerKt.getLifecycleScope(var1).getCoroutineContext();
   }
   ...
   public final BaseViewModel getSharedViewModel() {
      ...
      ViewModelProvider var2 = new ViewModelProvider((ViewModelStoreOwner)var1);
      Intrinsics.reifiedOperationMarker(4, "T");
      Class var3 = BaseViewModel.class;
      return (BaseViewModel)var2.get(BaseViewModel.class);
   }
   ...
   public final BaseViewModel getViewModel(ViewModelStoreOwner var1) {
      ...
      ViewModelProvider var2 = new ViewModelProvider(var1);
      Intrinsics.reifiedOperationMarker(4, "T");
      Class var3 = BaseViewModel.class;
      return (BaseViewModel)var2.get(BaseViewModel.class);
   }
   ...
   public void onResume() {
      ...
      if (var2 != null) {
         AnalyticsService var3 = this.getAnalytics();
         String var1 = this.getClass().getSimpleName();
         Intrinsics.checkNotNullExpressionValue(var1, "getSimpleName(...)");
         var3.event(new AnalyticEvent.ScreenViewEvent(var2, var1));
      }

      this.getRxSubs().add(RxExtensionsKt.subscribeAndLogE((Observable)this.getViewModel().getBaseActionPublisher(), new BaseFragment$$ExternalSyntheticLambda1(this)));
   }
}
