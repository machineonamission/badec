...
public final class ScanTypeAdapter extends RecyclerView.Adapter {
   ...
   public void onBindViewHolder(ScanTypeHolder var1, int var2) {
      Intrinsics.checkNotNullParameter(var1, "holder");
      var1.update((ScanInfoType)this.typeList.get(var2));
   }

   public ScanTypeHolder onCreateViewHolder(ViewGroup var1, int var2) {
      Intrinsics.checkNotNullParameter(var1, "parent");
      return ScanTypeHolder.Companion.newInstance(var1, this.scanType);
   }
}
