...
public class DataBinderMapperImpl extends DataBinderMapper {
   ...
   public List collectDependencies() {
      ...
      var1.add(new com.blueair.ble.DataBinderMapperImpl());
      var1.add(new com.blueair.bluetooth.DataBinderMapperImpl());
      var1.add(new com.blueair.core.DataBinderMapperImpl());
      var1.add(new com.blueair.database.DataBinderMapperImpl());
      var1.add(new com.blueair.livestream.DataBinderMapperImpl());
      return var1;
   }
