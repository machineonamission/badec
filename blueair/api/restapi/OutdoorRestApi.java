...
@Metadata(
   ...
   d2 = {"Lcom/blueair/api/restapi/OutdoorRestApi;", "", "getTrackedLocations", "Lkotlinx/coroutines/Deferred;", "", "Lcom/blueair/core/model/TrackedLocation;", "addTrackedLocation", "location", "removeTrackedLocation", "Lokhttp3/ResponseBody;", "locationId", "", "getAqiDataByLocationId", "Lcom/blueair/core/model/BlueAqiData;", "req", "Lcom/blueair/api/restapi/GetAqiDataByLocationIdReq;", "getAqiDataByLatLng", "Lcom/blueair/core/model/BlueAqiDataContent;", "Lcom/blueair/api/restapi/GetAqiDataByLatLngReq;", "Companion", "api_otherRelease"},
   k = 1,
   mv = {2, 2, 0},
   xi = 48
)
public interface OutdoorRestApi {
   String AQI_DATA = "c/outdoor/aqidata";
   Companion Companion = OutdoorRestApi.Companion.$$INSTANCE;
   String REMOVE_TRACKED_LOCATION = "c/outdoor/{locationId}";
   String TRACKED_LOCATION = "c/outdoor";

   @POST("c/outdoor")
   Deferred addTrackedLocation(@Body TrackedLocation var1);

   @POST("c/outdoor/aqidata")
   Deferred getAqiDataByLatLng(@Body GetAqiDataByLatLngReq var1);

   @POST("c/outdoor/aqidata")
   Deferred getAqiDataByLocationId(@Body GetAqiDataByLocationIdReq var1);

   @GET("c/outdoor")
   Deferred getTrackedLocations();

   @DELETE("c/outdoor/{locationId}")
   Deferred removeTrackedLocation(@Path("locationId") String var1);

   @Metadata(
      d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u000e\u0010\u0004\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0005X\u0086T¢\u0006\u0002\n\u0000¨\u0006\b"},
      d2 = {"Lcom/blueair/api/restapi/OutdoorRestApi$Companion;", "", "<init>", "()V", "TRACKED_LOCATION", "", "REMOVE_TRACKED_LOCATION", "AQI_DATA", "api_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
