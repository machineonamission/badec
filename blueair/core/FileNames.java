...
@Metadata(
   ...
   d2 = {"Lcom/blueair/core/FileNames;", "", "<init>", "()V", "TIMEZONE_LIST", "", "SKU_CONFIGURATIONS", "USER_INFO_COLLECTIONS", "DEBUG_LOG", "AQI_DATA_REFRESH_TIME_MAP_FILE", "BLE_DEVICE_MAC_NAME_MAP_FILE", "CHINA_PRIVACY_CONSENT_VERSION", "core_otherRelease"},
   k = 1,
   mv = {2, 2, 0},
   xi = 48
)
