...
public class HolderSsidHiddenBindingImpl extends HolderSsidHiddenBinding {
   ...
   public HolderSsidHiddenBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 1, sIncludes, sViewsWithIds));
   }

   private HolderSsidHiddenBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
