...
public class FragmentEnterDeviceNameBindingImpl extends FragmentEnterDeviceNameBinding {
   ...
   static {
      ...
      var0.put(R.id.input_deviceName, 3);
      var0.put(R.id.et_deviceName, 4);
      var0.put(R.id.buttonDone, 5);
      var0.put(R.id.progressView, 6);
   }

   public FragmentEnterDeviceNameBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 7, sIncludes, sViewsWithIds));
   }

   private FragmentEnterDeviceNameBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (MaterialButton)var3[5], (TextInputEditText)var3[4], (TextInputLayout)var3[3], (ProgressBlockerView)var3[6], (ConstraintLayout)var3[0], (AppCompatTextView)var3[2], (AppCompatTextView)var3[1]);
      this.mDirtyFlags = -1L;
