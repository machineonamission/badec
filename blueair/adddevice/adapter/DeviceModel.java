...
@Metadata(
   ...
   d2 = {"Lcom/blueair/adddevice/adapter/DeviceModel;", "", "modelName", "", "modelImageRes", "", "<init>", "(Ljava/lang/String;ILjava/lang/String;I)V", "getModelName", "()Ljava/lang/String;", "getModelImageRes", "()I", "CLASSIC", "SENSE", "AWARE", "ICP", "adddevice_otherRelease"},
   k = 1,
   mv = {2, 2, 0},
   xi = 48
)
public enum DeviceModel {
   ...
   // $FF: synthetic method
   private static final DeviceModel[] $values() {
      return new DeviceModel[]{CLASSIC, SENSE, AWARE, ICP};
   }
   ...
   private DeviceModel(String var3, int var4) {
      this.modelName = var3;
      this.modelImageRes = var4;
   }
