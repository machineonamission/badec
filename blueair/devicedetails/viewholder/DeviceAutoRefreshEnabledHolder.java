...
public final class DeviceAutoRefreshEnabledHolder extends DeviceSettingHolder {
   ...
   public DeviceAutoRefreshEnabledHolder(HolderDeviceSettingModeBinding var1) {
   ...
   public void update(Device var1) {
      ...
      super.update(var1);
      int var2 = R.string.auto_refresh;
      int var3 = R.string.auto_refresh_summary;
      TextView var7 = this.getSettingTitle();
      int var4 = R.drawable.ic_auto_refresh_leading;
      boolean var6 = false;
   ...
   @Metadata(
      ...
      d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceAutoRefreshEnabledHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceAutoRefreshEnabledHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
   public static final class Companion {
      ...
      public final DeviceAutoRefreshEnabledHolder newInstance(ViewGroup var1) {
         ...
         return new DeviceAutoRefreshEnabledHolder(var2);
      }
   }
}
