...
public final class DeviceAutoDryEnabledHolder extends DeviceSettingHolder {
   ...
   public DeviceAutoDryEnabledHolder(HolderDeviceSettingModeBinding var1) {
   ...
   public void update(Device var1) {
      ...
      if (var1 instanceof DeviceHumidifier) {
         var2 = R.string.auto_dry_description;
      } else {
         var2 = R.string.auto_dry_description_v2;
      }
   ...
   @Metadata(
      ...
      d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceAutoDryEnabledHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceAutoDryEnabledHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
   public static final class Companion {
      ...
      public final DeviceAutoDryEnabledHolder newInstance(ViewGroup var1) {
         ...
         return new DeviceAutoDryEnabledHolder(var2);
      }
   }
}
