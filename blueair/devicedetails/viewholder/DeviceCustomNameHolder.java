...
public final class DeviceCustomNameHolder extends DeviceSettingHolder {
   ...
   public DeviceCustomNameHolder(HolderDeviceRegularSettingBinding var1) {
   ...
   public void update(Device var1) {
      ...
      this.getSettingTitle().setText(this.itemView.getContext().getText(R.string.label_name));
      this.settingValue.setText((CharSequence)var1.getName());
   }

   @Metadata(
      d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"},
      d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceCustomNameHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceCustomNameHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
   public static final class Companion {
      ...
      public final DeviceCustomNameHolder newInstance(ViewGroup var1) {
         ...
         return new DeviceCustomNameHolder(var2);
      }
   }
}
