...
public final class DeviceRefresherEnabledHolder extends DeviceSettingHolder {
   ...
   public DeviceRefresherEnabledHolder(HolderDeviceSettingModeBinding var1) {
   ...
   public void update(Device var1) {
      ...
      super.update(var1);
      int var3 = R.string.label_water_refresher;
      int var2;
      if (var1 instanceof DeviceCombo2in120) {
         var2 = R.string.water_refresher_description_2in120;
      } else {
         var2 = R.string.water_refresher_description;
      }

      TextView var6 = this.getSettingTitle();
      int var4 = R.drawable.ic_water_refresher;
      boolean var5 = false;
      var6.setCompoundDrawablesRelativeWithIntrinsicBounds(var4, 0, 0, 0);
      ...
      SwitchCompat var8 = this.getSettingSwitch();
      ...
      if (var1 != null) {
         var5 = Intrinsics.areEqual(var1.getYwrmEnabled(), true);
      }

      var8.setCheckedSilence(var5);
   ...
   @Metadata(
      ...
      d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceRefresherEnabledHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceRefresherEnabledHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
   public static final class Companion {
      ...
      public final DeviceRefresherEnabledHolder newInstance(ViewGroup var1) {
         ...
         return new DeviceRefresherEnabledHolder(var2);
      }
   }
}
