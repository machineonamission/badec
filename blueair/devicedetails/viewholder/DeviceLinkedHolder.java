...
public final class DeviceLinkedHolder extends DeviceSettingHolder {
   ...
   public DeviceLinkedHolder(HolderDeviceRegularSettingBinding var1) {
   ...
   public final void update(DeviceAware var1) {
      this.getSettingTitle().setText(this.itemView.getContext().getText(R.string.linked_to));
      if (var1 != null) {
   ...
   @Metadata(
      ...
      d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceLinkedHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceLinkedHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
   public static final class Companion {
      ...
      public final DeviceLinkedHolder newInstance(ViewGroup var1) {
         ...
         return new DeviceLinkedHolder(var2);
      }
   }
}
