...
public final class DeviceDryModeHolder extends DeviceSettingHolder {
   ...
   public DeviceDryModeHolder(HolderDeviceRegularSettingBinding var1) {
   ...
   public void update(Device var1) {
      ...
      this.getSettingTitle().setText(this.itemView.getContext().getText(R.string.dry_mode));
      this.settingValue.setText((CharSequence)this.itemView.getContext().getString(var2));
   }

   @Metadata(
      d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u000e\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"},
      d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceDryModeHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceDryModeHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
   public static final class Companion {
      ...
      public final DeviceDryModeHolder newInstance(ViewGroup var1) {
         ...
         return new DeviceDryModeHolder(var2);
      }
   }
}
