...
public final class DeviceWickDryEnabledHolder extends DeviceSettingHolder {
   ...
   public DeviceWickDryEnabledHolder(HolderDeviceSettingModeBinding var1) {
   ...
   public void update(Device var1) {
      ...
      if (var1 instanceof DeviceCombo2in120) {
         var2 = R.string.label_auto_wick_drying;
         var3 = R.string.auto_wick_drying_desp;
      } else {
         var2 = R.string.label_wick_drying;
         var3 = R.string.wick_dry_description;
      }

      TextView var7 = this.getSettingTitle();
      int var4 = R.drawable.ic_dry_mode;
      boolean var6 = false;
   ...
   @Metadata(
      ...
      d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceWickDryEnabledHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceWickDryEnabledHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
   public static final class Companion {
      ...
      public final DeviceWickDryEnabledHolder newInstance(ViewGroup var1) {
         ...
         return new DeviceWickDryEnabledHolder(var2);
      }
   }
}
