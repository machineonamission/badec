...
public final class DeviceGermShieldHolder extends DeviceSettingHolder {
   ...
   public DeviceGermShieldHolder(HolderDeviceSettingModeBinding var1) {
   ...
   public void setOnline(Device var1) {
      ...
      if (var1 instanceof HasGermShieldMode) {
         this.getSettingSwitch().setCheckedSilence(((HasGermShieldMode)var1).isGermShieldModeOn());
      }
   ...
   public void update(Device var1) {
      ...
      if (((HasGermShieldMode)var1).isGermShieldPlus()) {
         var3 = R.string.germ_shield_plus;
         var4 = R.string.germ_shield_plus_mode_summary_v2;
         var2 = com.blueair.devicedetails.R.drawable.ic_germ_shield_plus_v2;
      } else {
         var3 = R.string.germ_shield_tm;
         var4 = R.string.germ_shield_mode_summary_v2;
         var2 = com.blueair.devicedetails.R.drawable.ic_germ_shield_v4;
      }

      this.getSettingTitle().setCompoundDrawablesRelativeWithIntrinsicBounds(var2, 0, 0, 0);
   ...
   @Metadata(
      ...
      d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceGermShieldHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceGermShieldHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
   public static final class Companion {
      ...
      public final DeviceGermShieldHolder newInstance(ViewGroup var1) {
         ...
         return new DeviceGermShieldHolder(var2);
      }
   }
}
