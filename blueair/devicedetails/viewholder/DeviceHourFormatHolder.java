...
public final class DeviceHourFormatHolder extends DeviceSettingHolder {
   ...
   public DeviceHourFormatHolder(HolderDeviceSettingModeBinding var1) {
   ...
   public void update(Device var1) {
      ...
      super.update(var1);
      int var3 = R.string.time_format;
      int var2 = R.string.time_format_desc;
      ...
      SwitchCompat var6 = this.getSettingSwitch();
      ...
      if (var1 != null) {
         var4 = var5;
         if (var1.getUse24Hour()) {
            var4 = true;
         }
      }

      var6.setCheckedSilence(var4);
      this.getSettingSummary().setText(this.itemView.getContext().getText(var2));
      ViewExtensionsKt.hide((View)this.getSettingSummary());
   }
   ...
   @Metadata(
      ...
      d2 = {"Lcom/blueair/devicedetails/viewholder/DeviceHourFormatHolder$Companion;", "", "<init>", "()V", "newInstance", "Lcom/blueair/devicedetails/viewholder/DeviceHourFormatHolder;", "parentView", "Landroid/view/ViewGroup;", "devicedetails_otherRelease"},
      k = 1,
      mv = {2, 2, 0},
      xi = 48
   )
   public static final class Companion {
      ...
      public final DeviceHourFormatHolder newInstance(ViewGroup var1) {
         ...
         return new DeviceHourFormatHolder(var2);
      }
   }
}
