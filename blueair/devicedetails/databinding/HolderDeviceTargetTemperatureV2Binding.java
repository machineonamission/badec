...
public final class HolderDeviceTargetTemperatureV2Binding implements ViewBinding {
   ...
   private HolderDeviceTargetTemperatureV2Binding(ConstraintLayout var1, View var2, ConstraintLayout var3, SwitchCompat var4, Group var5, ImageView var6, ImageView var7, TextView var8, AccessibleSeekBar var9, View var10, View var11, TextView var12, TextView var13, TextView var14) {
      this.rootView = var1;
      this.clickView = var2;
   ...
   public static HolderDeviceTargetTemperatureV2Binding bind(View var0) {
      ...
      if (var8 != null) {
         ...
         SwitchCompat var14 = (SwitchCompat)ViewBindings.findChildViewById(var0, var1);
         if (var14 != null) {
                              ...
                              if (var4 != null) {
                                 ...
                                 if (var5 != null) {
                                    ...
                                    if (var11 != null) {
                                       ...
                                       if (var13 != null) {
                                          return new HolderDeviceTargetTemperatureV2Binding(var2, var8, var2, var14, var9, var10, var3, var7, var12, var6, var4, var5, var11, var13);
                                       }
                                    }
                                 }
                              }
   ...
   public static HolderDeviceTargetTemperatureV2Binding inflate(LayoutInflater var0) {
      return inflate(var0, (ViewGroup)null, false);
   }

   public static HolderDeviceTargetTemperatureV2Binding inflate(LayoutInflater var0, ViewGroup var1, boolean var2) {
      View var3 = var0.inflate(R.layout.holder_device_target_temperature_v2, var1, false);
      if (var2) {
         var1.addView(var3);
      }
