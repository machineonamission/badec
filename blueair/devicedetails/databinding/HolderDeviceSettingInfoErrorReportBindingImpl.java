...
public class HolderDeviceSettingInfoErrorReportBindingImpl extends HolderDeviceSettingInfoErrorReportBinding {
   ...
   static {
      ...
      sViewsWithIds = var0;
      var0.put(R.id.info_title, 1);
      var0.put(R.id.info_view, 2);
   }

   public HolderDeviceSettingInfoErrorReportBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 3, sIncludes, sViewsWithIds));
   }

   private HolderDeviceSettingInfoErrorReportBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (TextView)var3[1], (TextView)var3[2]);
      this.mDirtyFlags = -1L;
