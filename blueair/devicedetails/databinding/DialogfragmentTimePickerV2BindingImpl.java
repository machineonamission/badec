...
public class DialogfragmentTimePickerV2BindingImpl extends DialogfragmentTimePickerV2Binding {
   ...
   static {
      ...
      var0.put(R.id.wheel_amPm, 9);
      var0.put(R.id.tv_hours, 10);
      var0.put(R.id.tv_mins, 11);
      var0.put(R.id.btn_done, 12);
   }

   public DialogfragmentTimePickerV2BindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 13, sIncludes, sViewsWithIds));
   }

   private DialogfragmentTimePickerV2BindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (AppCompatImageButton)var3[5], (MaterialButton)var3[12], (ConstraintLayout)var3[0], (AppCompatImageView)var3[3], (AppCompatImageView)var3[4], (TextView)var3[2], (AppCompatTextView)var3[7], (AppCompatTextView)var3[10], (AppCompatTextView)var3[11], (View)var3[1], (CustomWheelView)var3[9], (CustomWheelView)var3[6], (CustomWheelView)var3[8]);
      this.mDirtyFlags = -1L;
