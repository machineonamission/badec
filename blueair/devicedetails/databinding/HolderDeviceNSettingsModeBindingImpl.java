...
public class HolderDeviceNSettingsModeBindingImpl extends HolderDeviceNSettingsModeBinding {
   ...
   static {
      ...
      var0.put(R.id.switch_btn, 2);
      var0.put(R.id.desc_top_line, 3);
      var0.put(R.id.desc_text, 4);
      var0.put(R.id.separator, 5);
   }

   public HolderDeviceNSettingsModeBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 6, sIncludes, sViewsWithIds));
   }

   private HolderDeviceNSettingsModeBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (TextView)var3[4], (Barrier)var3[3], (View)var3[5], (SwitchCompat)var3[2], (TextView)var3[1]);
      this.mDirtyFlags = -1L;
