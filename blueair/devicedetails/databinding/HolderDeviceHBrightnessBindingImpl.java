...
public class HolderDeviceHBrightnessBindingImpl extends HolderDeviceHBrightnessBinding {
   ...
   static {
      ...
      var0.put(R.id.start_icon, 4);
      var0.put(R.id.seekbar, 5);
      var0.put(R.id.end_icon, 6);
   }

   public HolderDeviceHBrightnessBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 7, sIncludes, sViewsWithIds));
   }

   private HolderDeviceHBrightnessBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (ConstraintLayout)var3[1], (ImageView)var3[6], (TextView)var3[3], (AccessibleSeekBar)var3[5], (ImageView)var3[4], (TextView)var3[2]);
      this.mDirtyFlags = -1L;
