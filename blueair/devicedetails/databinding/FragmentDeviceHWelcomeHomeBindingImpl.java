...
public class FragmentDeviceHWelcomeHomeBindingImpl extends FragmentDeviceHWelcomeHomeBinding {
   ...
   static {
      ...
      sViewsWithIds = var0;
      var0.put(R.id.welcome_home_title, 8);
   }

   public FragmentDeviceHWelcomeHomeBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 9, sIncludes, sViewsWithIds));
   }

   private FragmentDeviceHWelcomeHomeBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 4, (MaterialButton)var3[2], (TextView)var3[5], (ImageView)var3[4], (ConstraintLayout)var3[3], (TextView)var3[6], (TextView)var3[7], (SwitchCompat)var3[1], (TextView)var3[8]);
      this.mDirtyFlags = -1L;
