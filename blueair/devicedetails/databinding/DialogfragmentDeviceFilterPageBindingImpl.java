...
public class DialogfragmentDeviceFilterPageBindingImpl extends DialogfragmentDeviceFilterPageBinding {
   ...
   static {
      ...
      var0.put(R.id.filter_widgets, 3);
      var0.put(R.id.progress_view, 4);
   }

   public DialogfragmentDeviceFilterPageBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 5, sIncludes, sViewsWithIds));
   }

   private DialogfragmentDeviceFilterPageBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (RecyclerView)var3[3], (ProgressBlockerView)var3[4], (CoordinatorLayout)var3[0], (TextView)var3[2], (Toolbar)var3[1]);
      this.mDirtyFlags = -1L;
