...
public class HolderDeviceHFanSpeedBindingImpl extends HolderDeviceHFanSpeedBinding {
   ...
   public HolderDeviceHFanSpeedBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 8, sIncludes, sViewsWithIds));
   }

   private HolderDeviceHFanSpeedBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (RadioGroup)var3[2], (RadioButton)var3[3], (RadioButton)var3[4], (RadioButton)var3[5], (RadioButton)var3[6], (RadioButton)var3[7], (TextView)var3[1]);
      this.mDirtyFlags = -1L;
