...
public class DialogfragmentDeviceErrorReportBindingImpl extends DialogfragmentDeviceErrorReportBinding {
   ...
   public DialogfragmentDeviceErrorReportBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 4, sIncludes, sViewsWithIds));
   }

   private DialogfragmentDeviceErrorReportBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
