...
public class ActivityDeleteAccountConfirmBindingImpl extends ActivityDeleteAccountConfirmBinding {
   ...
   static {
      ...
      var0.put(R.id.notice, 6);
      var0.put(R.id.btnDelete, 7);
      var0.put(R.id.loading, 8);
   }

   public ActivityDeleteAccountConfirmBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 9, sIncludes, sViewsWithIds));
   }

   private ActivityDeleteAccountConfirmBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (AppCompatImageButton)var3[2], (MaterialButton)var3[7], (TextView)var3[5], (ImageView)var3[4], (ProgressBlockerView)var3[8], (TextView)var3[6], (ScrollView)var3[3], (MaterialToolbar)var3[1]);
      this.mDirtyFlags = -1L;
