...
public class FragmentSmartIntegrationsBindingImpl extends FragmentSmartIntegrationsBinding {
   ...
   static {
      ...
      sViewsWithIds = var0;
      var0.put(R.id.integrations_recycler, 1);
      var0.put(R.id.txtNoIntegrations, 2);
      var0.put(R.id.loading, 3);
   }

   public FragmentSmartIntegrationsBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 4, sIncludes, sViewsWithIds));
   }

   private FragmentSmartIntegrationsBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
      super(var1, var2, 0, (RecyclerView)var3[1], (ProgressBlockerView)var3[3], (TextView)var3[2]);
      this.mDirtyFlags = -1L;
