...
public class DialogfragmentSmartIntegrationsBindingImpl extends DialogfragmentSmartIntegrationsBinding {
   ...
   static {
      ...
      var0.put(R.id.recyclerViewDevices, 3);
   }

   public DialogfragmentSmartIntegrationsBindingImpl(DataBindingComponent var1, View var2) {
      this(var1, var2, mapBindings(var1, var2, 4, sIncludes, sViewsWithIds));
   }

   private DialogfragmentSmartIntegrationsBindingImpl(DataBindingComponent var1, View var2, Object[] var3) {
