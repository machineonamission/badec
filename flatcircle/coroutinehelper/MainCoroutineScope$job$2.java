...
final class MainCoroutineScope$job$2 extends Lambda implements Function0<CompletableJob> {
    public static final MainCoroutineScope$job$2 INSTANCE = new MainCoroutineScope$job$2();

    MainCoroutineScope$job$2() {
        super(0);
    }
