...
final class IoCoroutineScope$job$2 extends Lambda implements Function0<CompletableJob> {
    public static final IoCoroutineScope$job$2 INSTANCE = new IoCoroutineScope$job$2();

    IoCoroutineScope$job$2() {
        super(0);
    }
