...
final class DefaultCoroutineScope$job$2 extends Lambda implements Function0<CompletableJob> {
    public static final DefaultCoroutineScope$job$2 INSTANCE = new DefaultCoroutineScope$job$2();

    DefaultCoroutineScope$job$2() {
        super(0);
    }
